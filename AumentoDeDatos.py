...
datagen = ImageDataGenerator(
        rotation_range=12,     #Random rotation between 0 and 45
...
x = io.imread('C:/Users/eduar/Escritorio/lalo/Melon_whitefly/IMG_20210215_163034.jpg')  #Array with shape (256, 256, 3)
...
for batch in datagen.flow(x, batch_size=16,  
                          save_to_dir='C:/Users/eduar/Escritorio/lalo/Basil', 
                          save_prefix='IMG_20210223_Melon_whitefly',
                          save_format='jpg'):
    i += 1
    if i > 20:
